...
export const canisterId = process.env.PROJECT1_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./project1_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the project1_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./project1_backend.did.js")._SERVICE>}
 */
export const project1_backend = createActor(canisterId);
