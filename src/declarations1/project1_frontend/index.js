...
import { idlFactory } from './project1_frontend.did.js';
export { idlFactory } from './project1_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PROJECT1_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./project1_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the project1_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./project1_frontend.did.js")._SERVICE>}
 */
export const project1_frontend = createActor(canisterId);
